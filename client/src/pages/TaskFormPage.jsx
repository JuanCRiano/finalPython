  ...
  useEffect(() => {
    async function loadTask(){
      if (params.id) {
        ...
        setValue("descrciption", res.data.description)
      }
    }
    loadTask()
  }, [])
  ...
  return (
    <div className="max-w-xl mx-auto ">
      <form onSubmit={onSubmit}>
        ...
        <textarea rows="3" /*value="Description"*/ placeholder="Description" {...register("description", {required: true})} className="bg-zinc-700 p-3 rounded-lg block w-full mb-3"> </textarea>
